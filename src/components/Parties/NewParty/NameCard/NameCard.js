...
export const NameCard = props => {
  ...
  const renderview = () => {
    <Text
      ...
      // numberOfLines={10}
    >
      Give a name and description to your new event to let your guests know what
      it is. You can also pass there information about your party (is it
      disguised for example ? etc).
    </Text>;
  };
  return (
